<script lang="ts">
  ...
  const navItems: NavItem[] = [
    ...
    { id: 'single', label: 'Einzelmodus', href: '/', icon: 'mdi:view-array', onclick: () => ($viewMode = 'single') },
    { id: 'gallery', label: 'Galerie', href: '/', icon: 'mdi:view-module', onclick: () => ($viewMode = 'gallery') },
    {
      id: 'presentation',
      label: 'Präsentation',
      href: '/',
