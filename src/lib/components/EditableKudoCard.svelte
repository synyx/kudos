<script lang="ts">
	...
	let kudoTitle: KudoTitle = $state(
		initialKudoTitleId ? kudoTitles[initialKudoTitleId] : kudoTitles.CONGRATS
	);
			...
			<div class="flex flex-col items-center">
				...
				<div class="controls-wrapper {svgActive ? 'active' : ''}">
					<div class="mt-2 flex flex-row space-x-2 justify-center">
						...
						<SimpleTooltip text="Wiederholen / Redo" shortcuts={['STRG + SHIFT + Z', 'STRG + Y']} disabled={tooltipDisabled}>
							<div>
								<button
									class="btn preset-filled-primary-100-900 grow w-full"
									id="redo"
					...
					<hr class="my-3" />
					<div>
						<SimpleTooltip text="Löscht deine Zeichnung" subText="kann rückgängig gemacht werden." disabled={tooltipDisabled}>
							<button
